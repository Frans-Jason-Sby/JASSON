...
def dump_massal():
	...
	for userr in uid:
		try:
			...
			sol().print(lo, style='cyan')
			exit()
	tot = '# TOTAL 👉 %s ID, BLACKHAT TEAM'%(len(id))
	if len(id)==0:
